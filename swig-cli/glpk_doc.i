%csmethodmodifiers lpx_put_solution(glp_prob *lp, int inval, const int *p_stat, const int *d_stat, const double *obj_val, const int r_stat[], const double r_prim[], const double r_dual[], const int c_stat[], const double c_prim[], const double c_dual[]) "
/**
...
%csmethodmodifiers lpx_put_mip_soln(LPX *lp, int i_stat, double row_mipx[], double col_mipx[]) "
/**
 */
public";
...
%csmethodmodifiers glp_skpgen(int n, int r, int type, int v, int s, int a[], int *b, int c[]) "
/**
 */
public";
...
%csmethodmodifiers load_data(SSX *ssx, LPX *lp) "
/**
 */
public";

%csmethodmodifiers load_basis(SSX *ssx, LPX *lp) "
/**
 */
public";
...
%csmethodmodifiers solve_mip(glp_prob *P, const glp_iocp *parm) "
/**
...
%csmethodmodifiers copy_bfcp(glp_prob *lp) "
/**
...
%csmethodmodifiers glp_get_bfcp(glp_prob *lp, glp_bfcp *parm) "
/**
...
%csmethodmodifiers glp_set_bfcp(glp_prob *lp, const glp_bfcp *parm) "
/**
 */
public";
...
%csmethodmodifiers bfd_set_parm(BFD *bfd, const void *_parm) "
/**
 */
public";

%csmethodmodifiers bfd_factorize(BFD *bfd, int m, const int bh[], int(*col)(void *info, int j, int ind[], double val[]), void *info) "
/**
...
%csmethodmodifiers bfd_update_it(BFD *bfd, int j, int bh, int len, const int ind[], const double val[]) "
/**
...
%csmethodmodifiers bfd_set_parm(BFD *bfd, const void *parm) "
/**
 */
public";
...
%csmethodmodifiers bfx_is_valid(BFX *binv) "
/**
 */
public";

%csmethodmodifiers bfx_invalidate(BFX *binv) "
/**
 */
public";
...
%csmethodmodifiers glp_malloc(int size) "
/**
...
%csmethodmodifiers glp_calloc(int n, int size) "
/**
...
%csmethodmodifiers glp_difftime(glp_long t1, glp_long t0) "
/**
...
%csmethodmodifiers lib_err_msg(const char *msg) "
/**
...
%csmethodmodifiers xerrmsg(void) "
/**
...
%csmethodmodifiers xfopen(const char *fname, const char *mode) "
/**
 */
public";

%csmethodmodifiers xferror(XFILE *file) "
/**
 */
public";

%csmethodmodifiers xfeof(XFILE *file) "
/**
 */
public";

%csmethodmodifiers xfgetc(XFILE *file) "
/**
 */
public";

%csmethodmodifiers xfputc(int c, XFILE *file) "
/**
 */
public";

%csmethodmodifiers xfflush(XFILE *fp) "
/**
 */
public";

%csmethodmodifiers xfclose(XFILE *file) "
/**
 */
public";

%csmethodmodifiers xfprintf(XFILE *file, const char *fmt,...) "
/**
 */
public";
...
%csmethodmodifiers glp_open_tee(const char *fname) "
/**
...
%csmethodmodifiers error(const char *fmt,...) "
/**
...
%csmethodmodifiers c_fopen(const char *fname, const char *mode) "
/**
...
%csmethodmodifiers z_fopen(const char *fname, const char *mode) "
/**
 */
public";

%csmethodmodifiers is_gz_file(const char *fname) "
/**
 */
public";
...
%csmethodmodifiers c_fgetc(void *fh) "
/**
...
%csmethodmodifiers z_fgetc(void *fh) "
/**
 */
public";

%csmethodmodifiers xfgetc(XFILE *fp) "
/**
 */
public";

%csmethodmodifiers c_fputc(int c, void *fh) "
/**
...
%csmethodmodifiers z_fputc(int c, void *fh) "
/**
 */
public";

%csmethodmodifiers xfputc(int c, XFILE *fp) "
/**
 */
public";

%csmethodmodifiers c_ferror(void *fh) "
/**
...
%csmethodmodifiers z_ferror(void *fh) "
/**
 */
public";

%csmethodmodifiers xferror(XFILE *fp) "
/**
 */
public";

%csmethodmodifiers c_feof(void *fh) "
/**
...
%csmethodmodifiers z_feof(void *fh) "
/**
 */
public";

%csmethodmodifiers xfeof(XFILE *fp) "
/**
 */
public";
...
%csmethodmodifiers c_fflush(void *fh) "
/**
...
%csmethodmodifiers z_fflush(void *fh) "
/**
 */
public";
...
%csmethodmodifiers c_fclose(void *fh) "
/**
...
%csmethodmodifiers z_fclose(void *fh) "
/**
 */
public";

%csmethodmodifiers xfclose(XFILE *fp) "
/**
 */
public";
...
%csmethodmodifiers fhv_create_it(void) "
/**
...
%csmethodmodifiers fhv_factorize(FHV *fhv, int m, int(*col)(void *info, int j, int ind[], double val[]), void *info) "
/**
...
%csmethodmodifiers fhv_h_solve(FHV *fhv, int tr, double x[]) "
/**
...
%csmethodmodifiers fhv_ftran(FHV *fhv, double x[]) "
/**
...
%csmethodmodifiers fhv_btran(FHV *fhv, double x[]) "
/**
...
%csmethodmodifiers fhv_update_it(FHV *fhv, int j, int len, const int ind[], const double val[]) "
/**
...
%csmethodmodifiers fhv_delete_it(FHV *fhv) "
/**
...
%csmethodmodifiers mpz_add(mpz_t, mpz_t, mpz_t) "
/**
 */
public";

%csmethodmodifiers mpz_sub(mpz_t, mpz_t, mpz_t) "
/**
 */
public";

%csmethodmodifiers mpz_mul(mpz_t, mpz_t, mpz_t) "
/**
 */
public";
...
%csmethodmodifiers mpz_out_str(void *fp, int base, mpz_t x) "
/**
 */
public";
...
%csmethodmodifiers mpq_out_str(void *fp, int base, mpq_t x) "
/**
 */
public";
...
%csmethodmodifiers triang(int m, int n, void *info, int(*mat)(void *info, int k, int ndx[]), int rn[], int cn[]) "
/**
 */
public";

%csmethodmodifiers mat(void *info, int k, int ndx[]) "
/**
 */
public";

%csmethodmodifiers adv_basis(glp_prob *lp) "
/**
 */
public";

%csmethodmodifiers glp_adv_basis(glp_prob *lp, int flags) "
/**
...
%csmethodmodifiers ios_driver(glp_tree *tree) "
/**
...
%csmethodmodifiers ios_clq_init(glp_tree *tree) "
/**
 */
public";

%csmethodmodifiers ios_clq_gen(glp_tree *tree, void *gen) "
/**
...
%csmethodmodifiers ios_clq_term(void *gen) "
/**
 */
public";
...
%csmethodmodifiers ios_pcost_branch(glp_tree *T, int *next) "
/**
 */
public";
...
%csmethodmodifiers lpx_cover_cut(LPX *lp, int len, int ind[], double val[], double work[]) "
/**
 */
public";

%csmethodmodifiers lpx_eval_row(LPX *lp, int len, int ind[], double val[]) "
/**
 */
public";
...
%csmethodmodifiers get_row_lb(LPX *lp, int i) "
/**
 */
public";

%csmethodmodifiers get_row_ub(LPX *lp, int i) "
/**
 */
public";

%csmethodmodifiers get_col_lb(LPX *lp, int j) "
/**
 */
public";

%csmethodmodifiers get_col_ub(LPX *lp, int j) "
/**
 */
public";

%csmethodmodifiers is_binary(LPX *lp, int j) "
/**
 */
public";

%csmethodmodifiers eval_lf_min(LPX *lp, int len, int ind[], double val[]) "
/**
 */
public";

%csmethodmodifiers eval_lf_max(LPX *lp, int len, int ind[], double val[]) "
/**
 */
public";

%csmethodmodifiers probing(int len, double val[], double L, double U, double lf_min, double lf_max, int p, int set, int q) "
/**
 */
public";

%csmethodmodifiers lpx_add_cog_edge(void *_cog, int i, int j) "
/**
 */
public";

%csmethodmodifiers lpx_create_cog(LPX *lp) "
/**
 */
public";

%csmethodmodifiers sub(struct dsa *dsa, int ct, int table[], int level, int weight, int l_weight) "
/**
 */
public";

%csmethodmodifiers wclique(int _n, int w[], unsigned char _a[], int sol[]) "
/**
 */
public";

%csmethodmodifiers lpx_clique_cut(LPX *lp, void *_cog, int ind[], double val[]) "
/**
 */
public";

%csmethodmodifiers lpx_delete_cog(void *_cog) "
/**
 */
public";
...
%csmethodmodifiers glp_set_prob_name(glp_prob *P, const char *name) "
/**
 * glp_set_prob_name - assign (change) problem name .
 * <p>SYNOPSIS</p>
 * <p>void glp_set_prob_name(glp_prob *lp, const char *name);</p>
...
%csmethodmodifiers glp_set_obj_name(glp_prob *P, const char *name) "
/**
 * glp_set_obj_name - assign (change) objective function name .
 * <p>SYNOPSIS</p>
 * <p>void glp_set_obj_name(glp_prob *lp, const char *name);</p>
...
%csmethodmodifiers glp_set_obj_dir(glp_prob *P, int dir) "
/**
 * glp_set_obj_dir - set (change) optimization direction flag .
 * <p>SYNOPSIS</p>
 * <p>void glp_set_obj_dir(glp_prob *lp, int dir);</p>
...
%csmethodmodifiers glp_add_rows(glp_prob *P, int nrs) "
/**
 * glp_add_rows - add new rows to problem object .
 * <p>SYNOPSIS</p>
 * <p>int glp_add_rows(glp_prob *lp, int nrs);</p>
...
%csmethodmodifiers glp_add_cols(glp_prob *P, int ncs) "
/**
 * glp_add_cols - add new columns to problem object .
 * <p>SYNOPSIS</p>
 * <p>int glp_add_cols(glp_prob *lp, int ncs);</p>
...
%csmethodmodifiers glp_set_row_name(glp_prob *P, int i, const char *name) "
/**
 * glp_set_row_name - assign (change) row name .
 * <p>SYNOPSIS</p>
 * <p>void glp_set_row_name(glp_prob *lp, int i, const char *name);</p>
...
%csmethodmodifiers glp_set_col_name(glp_prob *P, int j, const char *name) "
/**
 * glp_set_col_name - assign (change) column name .
 * <p>SYNOPSIS</p>
 * <p>void glp_set_col_name(glp_prob *lp, int j, const char *name);</p>
...
%csmethodmodifiers glp_set_row_bnds(glp_prob *P, int i, int type, double lb, double ub) "
/**
 * glp_set_row_bnds - set (change) row bounds .
 * <p>SYNOPSIS</p>
 * <p>void glp_set_row_bnds(glp_prob *lp, int i, int type, double lb, double ub);</p>
...
%csmethodmodifiers glp_set_col_bnds(glp_prob *P, int j, int type, double lb, double ub) "
/**
 * glp_set_col_bnds - set (change) column bounds .
 * <p>SYNOPSIS</p>
 * <p>void glp_set_col_bnds(glp_prob *lp, int j, int type, double lb, double ub);</p>
...
%csmethodmodifiers glp_set_obj_coef(glp_prob *P, int j, double coef) "
/**
 * glp_set_obj_coef - set (change) obj. .
 * <p>coefficient or constant term</p>
 * <p>SYNOPSIS</p>
...
%csmethodmodifiers glp_set_mat_row(glp_prob *P, int i, int len, const int ind[], const double val[]) "
/**
 * glp_set_mat_row - set (replace) row of the constraint matrix .
 * <p>SYNOPSIS</p>
 * <p>void glp_set_mat_row(glp_prob *lp, int i, int len, const int ind[], const double val[]);</p>
...
%csmethodmodifiers glp_set_mat_col(glp_prob *P, int j, int len, const int ind[], const double val[]) "
/**
 * glp_set_mat_col - set (replace) column of the constraint matrix .
 * <p>SYNOPSIS</p>
 * <p>void glp_set_mat_col(glp_prob *lp, int j, int len, const int ind[], const double val[]);</p>
...
%csmethodmodifiers glp_load_matrix(glp_prob *P, int ne, const int ia[], const int ja[], const double ar[]) "
/**
 * glp_load_matrix - load (replace) the whole constraint matrix .
 * <p>SYNOPSIS</p>
 * <p>void glp_load_matrix(glp_prob *lp, int ne, const int ia[], const int ja[], const double ar[]);</p>
...
%csmethodmodifiers glp_del_rows(glp_prob *P, int nrs, const int num[]) "
/**
 * glp_del_rows - delete rows from problem object .
 * <p>SYNOPSIS</p>
 * <p>void glp_del_rows(glp_prob *lp, int nrs, const int num[]);</p>
...
%csmethodmodifiers glp_del_cols(glp_prob *P, int ncs, const int num[]) "
/**
 * glp_del_cols - delete columns from problem object .
 * <p>SYNOPSIS</p>
 * <p>void glp_del_cols(glp_prob *lp, int ncs, const int num[]);</p>
...
%csmethodmodifiers glp_erase_prob(glp_prob *P) "
/**
 */
public";

%csmethodmodifiers glp_delete_prob(glp_prob *P) "
/**
 */
public";

%csmethodmodifiers glp_get_prob_name(glp_prob *P) "
/**
 * glp_get_prob_name - retrieve problem name .
 * <p>SYNOPSIS</p>
 * <p>const char *glp_get_prob_name(glp_prob *lp);</p>
...
%csmethodmodifiers glp_get_obj_name(glp_prob *P) "
/**
 * glp_get_obj_name - retrieve objective function name .
 * <p>SYNOPSIS</p>
 * <p>const char *glp_get_obj_name(glp_prob *lp);</p>
...
%csmethodmodifiers glp_get_obj_dir(glp_prob *P) "
/**
 * glp_get_obj_dir - retrieve optimization direction flag .
 * <p>SYNOPSIS</p>
 * <p>int glp_get_obj_dir(glp_prob *lp);</p>
...
%csmethodmodifiers glp_get_num_rows(glp_prob *P) "
/**
 * glp_get_num_rows - retrieve number of rows .
 * <p>SYNOPSIS</p>
 * <p>int glp_get_num_rows(glp_prob *lp);</p>
...
%csmethodmodifiers glp_get_num_cols(glp_prob *P) "
/**
 * glp_get_num_cols - retrieve number of columns .
 * <p>SYNOPSIS</p>
 * <p>int glp_get_num_cols(glp_prob *lp);</p>
...
%csmethodmodifiers glp_get_row_name(glp_prob *P, int i) "
/**
 * glp_get_row_name - retrieve row name .
 * <p>SYNOPSIS</p>
 * <p>const char *glp_get_row_name(glp_prob *lp, int i);</p>
...
%csmethodmodifiers glp_get_col_name(glp_prob *P, int j) "
/**
 * glp_get_col_name - retrieve column name .
 * <p>SYNOPSIS</p>
 * <p>const char *glp_get_col_name(glp_prob *lp, int j);</p>
...
%csmethodmodifiers glp_get_row_type(glp_prob *P, int i) "
/**
 * glp_get_row_type - retrieve row type .
 * <p>SYNOPSIS</p>
 * <p>int glp_get_row_type(glp_prob *lp, int i);</p>
...
%csmethodmodifiers glp_get_row_lb(glp_prob *P, int i) "
/**
 * glp_get_row_lb - retrieve row lower bound .
 * <p>SYNOPSIS</p>
 * <p>double glp_get_row_lb(glp_prob *lp, int i);</p>
...
%csmethodmodifiers glp_get_row_ub(glp_prob *P, int i) "
/**
 * glp_get_row_ub - retrieve row upper bound .
 * <p>SYNOPSIS</p>
 * <p>double glp_get_row_ub(glp_prob *lp, int i);</p>
...
%csmethodmodifiers glp_get_col_type(glp_prob *P, int j) "
/**
 * glp_get_col_type - retrieve column type .
 * <p>SYNOPSIS</p>
 * <p>int glp_get_col_type(glp_prob *lp, int j);</p>
...
%csmethodmodifiers glp_get_col_lb(glp_prob *P, int j) "
/**
 * glp_get_col_lb - retrieve column lower bound .
 * <p>SYNOPSIS</p>
 * <p>double glp_get_col_lb(glp_prob *lp, int j);</p>
...
%csmethodmodifiers glp_get_col_ub(glp_prob *P, int j) "
/**
 * glp_get_col_ub - retrieve column upper bound .
 * <p>SYNOPSIS</p>
 * <p>double glp_get_col_ub(glp_prob *lp, int j);</p>
...
%csmethodmodifiers glp_get_obj_coef(glp_prob *P, int j) "
/**
 * glp_get_obj_coef - retrieve obj. .
 * <p>coefficient or constant term</p>
 * <p>SYNOPSIS</p>
...
%csmethodmodifiers glp_get_num_nz(glp_prob *P) "
/**
 * glp_get_num_nz - retrieve number of constraint coefficients .
 * <p>SYNOPSIS</p>
 * <p>int glp_get_num_nz(glp_prob *lp);</p>
...
%csmethodmodifiers glp_get_mat_row(glp_prob *P, int i, int ind[], double val[]) "
/**
 * glp_get_mat_row - retrieve row of the constraint matrix .
 * <p>SYNOPSIS</p>
 * <p>int glp_get_mat_row(glp_prob *lp, int i, int ind[], double val[]);</p>
...
%csmethodmodifiers glp_get_mat_col(glp_prob *P, int j, int ind[], double val[]) "
/**
 * glp_get_mat_col - retrieve column of the constraint matrix .
 * <p>SYNOPSIS</p>
 * <p>int glp_get_mat_col(glp_prob *lp, int j, int ind[], double val[]);</p>
...
%csmethodmodifiers glp_create_index(glp_prob *P) "
/**
 * glp_create_index - create the name index .
 * <p>SYNOPSIS</p>
 * <p>void glp_create_index(glp_prob *lp);</p>
...
%csmethodmodifiers glp_find_row(glp_prob *P, const char *name) "
/**
 * glp_find_row - find row by its name .
 * <p>SYNOPSIS</p>
 * <p>int glp_find_row(glp_prob *lp, const char *name);</p>
...
%csmethodmodifiers glp_find_col(glp_prob *P, const char *name) "
/**
 * glp_find_col - find column by its name .
 * <p>SYNOPSIS</p>
 * <p>int glp_find_col(glp_prob *lp, const char *name);</p>
...
%csmethodmodifiers glp_delete_index(glp_prob *P) "
/**
 * glp_delete_index - delete the name index .
 * <p>SYNOPSIS</p>
 * <p>void glp_delete_index(glp_prob *lp);</p>
...
%csmethodmodifiers glp_set_rii(glp_prob *P, int i, double rii) "
/**
 * glp_set_rii - set (change) row scale factor .
 * <p>SYNOPSIS</p>
 * <p>void glp_set_rii(glp_prob *lp, int i, double rii);</p>
...
%csmethodmodifiers glp_set_sjj(glp_prob *P, int j, double sjj) "
/**
 * glp_set sjj - set (change) column scale factor .
 * <p>SYNOPSIS</p>
 * <p>void glp_set_sjj(glp_prob *lp, int j, double sjj);</p>
...
%csmethodmodifiers glp_get_rii(glp_prob *P, int i) "
/**
 * glp_get_rii - retrieve row scale factor .
 * <p>SYNOPSIS</p>
 * <p>double glp_get_rii(glp_prob *lp, int i);</p>
...
%csmethodmodifiers glp_get_sjj(glp_prob *P, int j) "
/**
 * glp_get_sjj - retrieve column scale factor .
 * <p>SYNOPSIS</p>
 * <p>double glp_get_sjj(glp_prob *lp, int j);</p>
...
%csmethodmodifiers glp_scale_prob(glp_prob *P, int flags) "
/**
...
%csmethodmodifiers glp_unscale_prob(glp_prob *P) "
/**
 * glp_unscale_prob - unscale problem data .
 * <p>SYNOPSIS</p>
 * <p>void glp_unscale_prob(glp_prob *lp);</p>
...
%csmethodmodifiers glp_set_row_stat(glp_prob *P, int i, int stat) "
/**
 * glp_set_row_stat - set (change) row status .
 * <p>SYNOPSIS</p>
 * <p>void glp_set_row_stat(glp_prob *lp, int i, int stat);</p>
...
%csmethodmodifiers glp_set_col_stat(glp_prob *P, int j, int stat) "
/**
 * glp_set_col_stat - set (change) column status .
 * <p>SYNOPSIS</p>
 * <p>void glp_set_col_stat(glp_prob *lp, int j, int stat);</p>
...
%csmethodmodifiers glp_std_basis(glp_prob *P) "
/**
 * glp_std_basis - construct standard initial LP basis .
 * <p>SYNOPSIS</p>
 * <p>void glp_std_basis(glp_prob *lp);</p>
...
%csmethodmodifiers glp_cpx_basis(glp_prob *P) "
/**
 * glp_cpx_basis - construct Bixby's initial LP basis .
 * <p>SYNOPSIS</p>
 * <p>void glp_cpx_basis(glp_prob *lp);</p>
...
%csmethodmodifiers glp_exact(glp_prob *P, const glp_smcp *parm) "
/**
 */
public";
...
%csmethodmodifiers glp_get_status(glp_prob *P) "
/**
 * glp_get_status - retrieve generic status of basic solution .
 * <p>SYNOPSIS</p>
 * <p>int glp_get_status(glp_prob *lp);</p>
...
%csmethodmodifiers glp_get_prim_stat(glp_prob *P) "
/**
 * glp_get_prim_stat - retrieve status of primal basic solution .
 * <p>SYNOPSIS</p>
 * <p>int glp_get_prim_stat(glp_prob *lp);</p>
...
%csmethodmodifiers glp_get_dual_stat(glp_prob *P) "
/**
 * glp_get_dual_stat - retrieve status of dual basic solution .
 * <p>SYNOPSIS</p>
 * <p>int glp_get_dual_stat(glp_prob *lp);</p>
...
%csmethodmodifiers glp_get_obj_val(glp_prob *P) "
/**
 * glp_get_obj_val - retrieve objective value (basic solution) .
 * <p>SYNOPSIS</p>
 * <p>double glp_get_obj_val(glp_prob *lp);</p>
...
%csmethodmodifiers glp_get_row_stat(glp_prob *P, int i) "
/**
 * glp_get_row_stat - retrieve row status .
 * <p>SYNOPSIS</p>
 * <p>int glp_get_row_stat(glp_prob *lp, int i);</p>
...
%csmethodmodifiers glp_get_row_prim(glp_prob *P, int i) "
/**
 * glp_get_row_prim - retrieve row primal value (basic solution) .
 * <p>SYNOPSIS</p>
 * <p>double glp_get_row_prim(glp_prob *lp, int i);</p>
...
%csmethodmodifiers glp_get_row_dual(glp_prob *P, int i) "
/**
 * glp_get_row_dual - retrieve row dual value (basic solution) .
 * <p>SYNOPSIS</p>
 * <p>double glp_get_row_dual(glp_prob *lp, int i);</p>
...
%csmethodmodifiers glp_get_col_stat(glp_prob *P, int j) "
/**
 * glp_get_col_stat - retrieve column status .
 * <p>SYNOPSIS</p>
 * <p>int glp_get_col_stat(glp_prob *lp, int j);</p>
...
%csmethodmodifiers glp_get_col_prim(glp_prob *P, int j) "
/**
 * glp_get_col_prim - retrieve column primal value (basic solution) .
 * <p>SYNOPSIS</p>
 * <p>double glp_get_col_prim(glp_prob *lp, int j);</p>
...
%csmethodmodifiers glp_get_col_dual(glp_prob *P, int j) "
/**
 * glp_get_col_dual - retrieve column dual value (basic solution) .
 * <p>SYNOPSIS</p>
 * <p>double glp_get_col_dual(glp_prob *lp, int j);</p>
...
%csmethodmodifiers glp_get_unbnd_ray(glp_prob *P) "
/**
 * glp_get_unbnd_ray - determine variable causing unboundedness .
 * <p>SYNOPSIS</p>
 * <p>int glp_get_unbnd_ray(glp_prob *lp);</p>
...
%csmethodmodifiers glp_ipt_status(glp_prob *P) "
/**
 * glp_ipt_status - retrieve status of interior-point solution .
 * <p>SYNOPSIS</p>
 * <p>int glp_ipt_status(glp_prob *lp);</p>
...
%csmethodmodifiers glp_ipt_obj_val(glp_prob *P) "
/**
 * glp_ipt_obj_val - retrieve objective value (interior point) .
 * <p>SYNOPSIS</p>
 * <p>double glp_ipt_obj_val(glp_prob *lp);</p>
...
%csmethodmodifiers glp_ipt_row_prim(glp_prob *P, int i) "
/**
 * glp_ipt_row_prim - retrieve row primal value (interior point) .
 * <p>SYNOPSIS</p>
 * <p>double glp_ipt_row_prim(glp_prob *lp, int i);</p>
...
%csmethodmodifiers glp_ipt_row_dual(glp_prob *P, int i) "
/**
 * glp_ipt_row_dual - retrieve row dual value (interior point) .
 * <p>SYNOPSIS</p>
 * <p>double glp_ipt_row_dual(glp_prob *lp, int i);</p>
...
%csmethodmodifiers glp_ipt_col_prim(glp_prob *P, int j) "
/**
 * glp_ipt_col_prim - retrieve column primal value (interior point) .
 * <p>SYNOPSIS</p>
 * <p>double glp_ipt_col_prim(glp_prob *lp, int j);</p>
...
%csmethodmodifiers glp_ipt_col_dual(glp_prob *P, int j) "
/**
 * glp_ipt_col_dual - retrieve column dual value (interior point) .
 * <p>SYNOPSIS</p>
 * <p>#include \"glplpx.h\" double glp_ipt_col_dual(glp_prob *lp, int j);</p>
...
%csmethodmodifiers glp_set_col_kind(glp_prob *P, int j, int kind) "
/**
 * glp_set_col_kind - set (change) column kind .
 * <p>SYNOPSIS</p>
 * <p>void glp_set_col_kind(glp_prob *mip, int j, int kind);</p>
...
%csmethodmodifiers glp_get_col_kind(glp_prob *P, int j) "
/**
 * glp_get_col_kind - retrieve column kind .
 * <p>SYNOPSIS</p>
 * <p>int glp_get_col_kind(glp_prob *mip, int j);</p>
...
%csmethodmodifiers glp_get_num_int(glp_prob *P) "
/**
 * glp_get_num_int - retrieve number of integer columns .
 * <p>SYNOPSIS</p>
 * <p>int glp_get_num_int(glp_prob *mip);</p>
...
%csmethodmodifiers glp_get_num_bin(glp_prob *P) "
/**
 * glp_get_num_bin - retrieve number of binary columns .
 * <p>SYNOPSIS</p>
 * <p>int glp_get_num_bin(glp_prob *mip);</p>
...
%csmethodmodifiers glp_mip_status(glp_prob *P) "
/**
 * glp_mip_status - retrieve status of MIP solution .
 * <p>SYNOPSIS</p>
 * <p>int glp_mip_status(glp_prob *mip);</p>
...
%csmethodmodifiers glp_mip_obj_val(glp_prob *P) "
/**
 * glp_mip_obj_val - retrieve objective value (MIP solution) .
 * <p>SYNOPSIS</p>
 * <p>double glp_mip_obj_val(glp_prob *mip);</p>
...
%csmethodmodifiers glp_mip_row_val(glp_prob *P, int i) "
/**
 * glp_mip_row_val - retrieve row value (MIP solution) .
 * <p>SYNOPSIS</p>
 * <p>double glp_mip_row_val(glp_prob *mip, int i);</p>
...
%csmethodmodifiers glp_mip_col_val(glp_prob *P, int j) "
/**
 * glp_mip_col_val - retrieve column value (MIP solution) .
 * <p>SYNOPSIS</p>
 * <p>double glp_mip_col_val(glp_prob *mip, int j);</p>
...
%csmethodmodifiers glp_check_kkt(glp_prob *P, int sol, int cond, double *ae_max, int *ae_ind, double *re_max, int *re_ind) "
/**
 */
public";
...
%csmethodmodifiers glp_read_sol(glp_prob *P, const char *fname) "
/**
 * glp_read_sol - read basic solution from text file .
 * <p>SYNOPSIS</p>
 * <p>int glp_read_sol(glp_prob *lp, const char *fname);</p>
...
%csmethodmodifiers glp_write_sol(glp_prob *P, const char *fname) "
/**
 * glp_write_sol - write basic solution to text file .
 * <p>SYNOPSIS</p>
 * <p>int glp_write_sol(glp_prob *lp, const char *fname);</p>
...
%csmethodmodifiers glp_read_ipt(glp_prob *P, const char *fname) "
/**
 * glp_read_ipt - read interior-point solution from text file .
 * <p>SYNOPSIS</p>
 * <p>int glp_read_ipt(glp_prob *lp, const char *fname);</p>
...
%csmethodmodifiers glp_write_ipt(glp_prob *P, const char *fname) "
/**
 * glp_write_ipt - write interior-point solution to text file .
 * <p>SYNOPSIS</p>
 * <p>int glp_write_ipt(glp_prob *lp, const char *fname);</p>
...
%csmethodmodifiers glp_read_mip(glp_prob *P, const char *fname) "
/**
 * glp_read_mip - read MIP solution from text file .
 * <p>SYNOPSIS</p>
 * <p>int glp_read_mip(glp_prob *mip, const char *fname);</p>
...
%csmethodmodifiers glp_write_mip(glp_prob *P, const char *fname) "
/**
 * glp_write_mip - write MIP solution to text file .
 * <p>SYNOPSIS</p>
 * <p>int glp_write_mip(glp_prob *mip, const char *fname);</p>
...
%csmethodmodifiers glp_bf_exists(glp_prob *P) "
/**
 * glp_bf_exists - check if the basis factorization exists .
 * <p>SYNOPSIS</p>
 * <p>int glp_bf_exists(glp_prob *lp);</p>
...
%csmethodmodifiers glp_factorize(glp_prob *P) "
/**
 */
public";

%csmethodmodifiers glp_bf_updated(glp_prob *P) "
/**
 * glp_bf_updated - check if the basis factorization has been updated .
 * <p>SYNOPSIS</p>
 * <p>int glp_bf_updated(glp_prob *lp);</p>
...
%csmethodmodifiers glp_get_bhead(glp_prob *P, int k) "
/**
 * glp_get_bhead - retrieve the basis header information .
 * <p>SYNOPSIS</p>
 * <p>int glp_get_bhead(glp_prob *lp, int k);</p>
...
%csmethodmodifiers glp_get_row_bind(glp_prob *P, int i) "
/**
 * glp_get_row_bind - retrieve row index in the basis header .
 * <p>SYNOPSIS</p>
 * <p>int glp_get_row_bind(glp_prob *lp, int i);</p>
...
%csmethodmodifiers glp_get_col_bind(glp_prob *P, int j) "
/**
 * glp_get_col_bind - retrieve column index in the basis header .
 * <p>SYNOPSIS</p>
 * <p>int glp_get_col_bind(glp_prob *lp, int j);</p>
...
%csmethodmodifiers glp_ftran(glp_prob *P, double x[]) "
/**
 * glp_ftran - perform forward transformation (solve system B*x = b) .
 * <p>SYNOPSIS</p>
 * <p>void glp_ftran(glp_prob *lp, double x[]);</p>
...
%csmethodmodifiers glp_btran(glp_prob *P, double x[]) "
/**
 * glp_btran - perform backward transformation (solve system B'*x = b) .
 * <p>SYNOPSIS</p>
 * <p>void glp_btran(glp_prob *lp, double x[]);</p>
...
%csmethodmodifiers glp_eval_tab_row(glp_prob *P, int k, int ind[], double val[]) "
/**
 * glp_eval_tab_row - compute row of the simplex tableau .
 * <p>SYNOPSIS</p>
 * <p>int glp_eval_tab_row(glp_prob *lp, int k, int ind[], double val[]);</p>
...
%csmethodmodifiers glp_eval_tab_col(glp_prob *P, int k, int ind[], double val[]) "
/**
 * glp_eval_tab_col - compute column of the simplex tableau .
 * <p>SYNOPSIS</p>
 * <p>int glp_eval_tab_col(glp_prob *lp, int k, int ind[], double val[]);</p>
...
%csmethodmodifiers glp_ios_reason(glp_tree *T) "
/**
 * glp_ios_reason - determine reason for calling the callback routine .
 * <p>SYNOPSIS</p>
 * <p>glp_ios_reason(glp_tree *tree);</p>
...
%csmethodmodifiers glp_ios_get_prob(glp_tree *T) "
/**
 * glp_ios_get_prob - access the problem object .
 * <p>SYNOPSIS</p>
 * <p>glp_prob *glp_ios_get_prob(glp_tree *tree);</p>
...
%csmethodmodifiers glp_ios_tree_size(glp_tree *T, int *a_cnt, int *n_cnt, int *t_cnt) "
/**
 * glp_ios_tree_size - determine size of the branch-and-bound tree .
 * <p>SYNOPSIS</p>
 * <p>void glp_ios_tree_size(glp_tree *tree, int *a_cnt, int *n_cnt, int *t_cnt);</p>
...
%csmethodmodifiers glp_ios_curr_node(glp_tree *T) "
/**
 * glp_ios_curr_node - determine current active subproblem .
 * <p>SYNOPSIS</p>
 * <p>int glp_ios_curr_node(glp_tree *tree);</p>
...
%csmethodmodifiers glp_ios_next_node(glp_tree *T, int p) "
/**
 * glp_ios_next_node - determine next active subproblem .
 * <p>SYNOPSIS</p>
 * <p>int glp_ios_next_node(glp_tree *tree, int p);</p>
...
%csmethodmodifiers glp_ios_prev_node(glp_tree *T, int p) "
/**
 * glp_ios_prev_node - determine previous active subproblem .
 * <p>SYNOPSIS</p>
 * <p>int glp_ios_prev_node(glp_tree *tree, int p);</p>
...
%csmethodmodifiers glp_ios_up_node(glp_tree *T, int p) "
/**
 * glp_ios_up_node - determine parent subproblem .
 * <p>SYNOPSIS</p>
 * <p>int glp_ios_up_node(glp_tree *tree, int p);</p>
...
%csmethodmodifiers glp_ios_node_level(glp_tree *T, int p) "
/**
 * glp_ios_node_level - determine subproblem level .
 * <p>SYNOPSIS</p>
 * <p>int glp_ios_node_level(glp_tree *tree, int p);</p>
...
%csmethodmodifiers glp_ios_node_bound(glp_tree *T, int p) "
/**
 * glp_ios_node_bound - determine subproblem local bound .
 * <p>SYNOPSIS</p>
 * <p>double glp_ios_node_bound(glp_tree *tree, int p);</p>
...
%csmethodmodifiers glp_ios_best_node(glp_tree *T) "
/**
 * glp_ios_best_node - find active subproblem with best local bound .
 * <p>SYNOPSIS</p>
 * <p>int glp_ios_best_node(glp_tree *tree);</p>
...
%csmethodmodifiers glp_ios_mip_gap(glp_tree *T) "
/**
 * glp_ios_mip_gap - compute relative MIP gap .
 * <p>SYNOPSIS</p>
 * <p>double glp_ios_mip_gap(glp_tree *tree);</p>
...
%csmethodmodifiers glp_ios_node_data(glp_tree *T, int p) "
/**
 * glp_ios_node_data - access subproblem application-specific data .
 * <p>SYNOPSIS</p>
 * <p>void *glp_ios_node_data(glp_tree *tree, int p);</p>
...
%csmethodmodifiers glp_ios_row_attr(glp_tree *T, int i, glp_attr *attr) "
/**
 * glp_ios_row_attr - retrieve additional row attributes .
 * <p>SYNOPSIS</p>
 * <p>void glp_ios_row_attr(glp_tree *tree, int i, glp_attr *attr);</p>
...
%csmethodmodifiers glp_ios_pool_size(glp_tree *T) "
/**
 */
public";

%csmethodmodifiers glp_ios_add_row(glp_tree *T, const char *name, int klass, int flags, int len, const int ind[], const double val[], int type, double rhs) "
/**
 */
public";

%csmethodmodifiers glp_ios_del_row(glp_tree *T, int i) "
/**
 */
public";

%csmethodmodifiers glp_ios_clear_pool(glp_tree *T) "
/**
 */
public";

%csmethodmodifiers glp_ios_can_branch(glp_tree *T, int j) "
/**
 * glp_ios_can_branch - check if can branch upon specified variable .
 * <p>SYNOPSIS</p>
 * <p>int glp_ios_can_branch(glp_tree *tree, int j);</p>
...
%csmethodmodifiers glp_ios_branch_upon(glp_tree *T, int j, int sel) "
/**
 * glp_ios_branch_upon - choose variable to branch upon .
 * <p>SYNOPSIS</p>
 * <p>void glp_ios_branch_upon(glp_tree *tree, int j, int sel);</p>
...
%csmethodmodifiers glp_ios_select_node(glp_tree *T, int p) "
/**
 * glp_ios_select_node - select subproblem to continue the search .
 * <p>SYNOPSIS</p>
 * <p>void glp_ios_select_node(glp_tree *tree, int p);</p>
...
%csmethodmodifiers glp_ios_heur_sol(glp_tree *T, const double x[]) "
/**
 * glp_ios_heur_sol - provide solution found by heuristic .
 * <p>SYNOPSIS</p>
 * <p>int glp_ios_heur_sol(glp_tree *tree, const double x[]);</p>
...
%csmethodmodifiers glp_ios_terminate(glp_tree *T) "
/**
 * glp_ios_terminate - terminate the solution process. .
 * <p>SYNOPSIS</p>
 * <p>void glp_ios_terminate(glp_tree *tree);</p>
...
%csmethodmodifiers glp_mincost_lp(glp_prob *P, glp_graph *G, int names, int v_rhs, int a_low, int a_cap, int a_cost) "
/**
 * glp_mincost_lp - convert minimum cost flow problem to LP .
 * <p>SYNOPSIS</p>
 * <p>void glp_mincost_lp(glp_prob *lp, glp_graph *G, int names, int v_rhs, int a_low, int a_cap, int a_cost);</p>
...
%csmethodmodifiers glp_maxflow_lp(glp_prob *P, glp_graph *G, int names, int s, int t, int a_cap) "
/**
 * glp_maxflow_lp - convert maximum flow problem to LP .
 * <p>SYNOPSIS</p>
 * <p>void glp_maxflow_lp(glp_prob *lp, glp_graph *G, int names, int s, int t, int a_cap);</p>
...
%csmethodmodifiers glp_read_maxflow(glp_graph *G, int *s, int *t, int a_cap, const char *fname) "
/**
 * glp_read_maxflow - read maximum flow problem data in DIMACS format .
 * <p>SYNOPSIS</p>
 * <p>int glp_read_maxflow(glp_graph *G, int *s, int *t, int a_cap, const char *fname);</p>
...
%csmethodmodifiers glp_netgen(glp_graph *G, int v_rhs, int a_cap, int a_cost, const int parm[1+15]) "
/**
 */
public";
...
%csmethodmodifiers glp_gridgen(glp_graph *G, int v_rhs, int a_cap, int a_cost, const int parm[1+14]) "
/**
 */
public";

%csmethodmodifiers glp_rmfgen(glp_graph *G, int *s, int *t, int a_cap, const int parm[1+5]) "
/**
 */
public";
...
%csmethodmodifiers xlneg(glp_long x) "
/**
...
%csmethodmodifiers xladd(glp_long x, glp_long y) "
/**
...
%csmethodmodifiers xlsub(glp_long x, glp_long y) "
/**
...
%csmethodmodifiers xlcmp(glp_long x, glp_long y) "
/**
...
%csmethodmodifiers xlmul(glp_long x, glp_long y) "
/**
...
%csmethodmodifiers xldiv(glp_long x, glp_long y) "
/**
...
%csmethodmodifiers xltod(glp_long x) "
/**
...
%csmethodmodifiers xltoa(glp_long x, char *s) "
/**
 */
public";

%csmethodmodifiers str2int(const char *str, int *val) "
/**
...
%csmethodmodifiers str2num(const char *str, double *val) "
/**
...
%csmethodmodifiers strrev(char *s) "
/**
...
%csmethodmodifiers lcm(int x, int y) "
/**
...
%csmethodmodifiers lcmn(int n, int x[]) "
/**
...
%csmethodmodifiers jdate(int j, int *d, int *m, int *y) "
/**
...
%csmethodmodifiers str2int(const char *str, int *_val) "
/**
 * str2int - convert character string to value of int type .
 * <p>SYNOPSIS</p>
 * <p>#include \"glplib.h\" int str2int(const char *str, int *val);</p>
...
%csmethodmodifiers str2num(const char *str, double *_val) "
/**
 * str2num - convert character string to value of double type .
 * <p>SYNOPSIS</p>
 * <p>#include \"glplib.h\" int str2num(const char *str, double *val);</p>
...
%csmethodmodifiers jdate(int j, int *_d, int *_m, int *_y) "
/**
 * jdate - convert Julian day number to calendar date .
 * <p>SYNOPSIS</p>
 * <p>#include \"glplib.h\" void jdate(int j, int *d, int *m, int *y);</p>
...
%csmethodmodifiers lpf_create_it(void) "
/**
...
%csmethodmodifiers lpf_factorize(LPF *lpf, int m, const int bh[], int(*col)(void *info, int j, int ind[], double val[]), void *info) "
/**
...
%csmethodmodifiers r_prod(LPF *lpf, double y[], double a, const double x[]) "
/**
 */
public";

%csmethodmodifiers rt_prod(LPF *lpf, double y[], double a, const double x[]) "
/**
 */
public";

%csmethodmodifiers s_prod(LPF *lpf, double y[], double a, const double x[]) "
/**
 */
public";

%csmethodmodifiers st_prod(LPF *lpf, double y[], double a, const double x[]) "
/**
 */
public";

%csmethodmodifiers lpf_ftran(LPF *lpf, double x[]) "
/**
...
%csmethodmodifiers lpf_btran(LPF *lpf, double x[]) "
/**
...
%csmethodmodifiers enlarge_sva(LPF *lpf, int new_size) "
/**
 */
public";

%csmethodmodifiers lpf_update_it(LPF *lpf, int j, int bh, int len, const int ind[], const double val[]) "
/**
...
%csmethodmodifiers lpf_delete_it(LPF *lpf) "
/**
...
%csmethodmodifiers lpx_create_prob(void) "
/**
 */
public";

%csmethodmodifiers lpx_set_prob_name(LPX *lp, const char *name) "
/**
 */
public";

%csmethodmodifiers lpx_set_obj_name(LPX *lp, const char *name) "
/**
 */
public";

%csmethodmodifiers lpx_set_obj_dir(LPX *lp, int dir) "
/**
 */
public";

%csmethodmodifiers lpx_add_rows(LPX *lp, int nrs) "
/**
 */
public";

%csmethodmodifiers lpx_add_cols(LPX *lp, int ncs) "
/**
 */
public";

%csmethodmodifiers lpx_set_row_name(LPX *lp, int i, const char *name) "
/**
 */
public";

%csmethodmodifiers lpx_set_col_name(LPX *lp, int j, const char *name) "
/**
 */
public";

%csmethodmodifiers lpx_set_row_bnds(LPX *lp, int i, int type, double lb, double ub) "
/**
 */
public";

%csmethodmodifiers lpx_set_col_bnds(LPX *lp, int j, int type, double lb, double ub) "
/**
 */
public";

%csmethodmodifiers lpx_set_obj_coef(glp_prob *lp, int j, double coef) "
/**
 */
public";

%csmethodmodifiers lpx_set_mat_row(LPX *lp, int i, int len, const int ind[], const double val[]) "
/**
 */
public";

%csmethodmodifiers lpx_set_mat_col(LPX *lp, int j, int len, const int ind[], const double val[]) "
/**
 */
public";

%csmethodmodifiers lpx_load_matrix(LPX *lp, int ne, const int ia[], const int ja[], const double ar[]) "
/**
 */
public";

%csmethodmodifiers lpx_del_rows(LPX *lp, int nrs, const int num[]) "
/**
 */
public";

%csmethodmodifiers lpx_del_cols(LPX *lp, int ncs, const int num[]) "
/**
 */
public";

%csmethodmodifiers lpx_delete_prob(LPX *lp) "
/**
 */
public";

%csmethodmodifiers lpx_get_prob_name(LPX *lp) "
/**
 */
public";

%csmethodmodifiers lpx_get_obj_name(LPX *lp) "
/**
 */
public";

%csmethodmodifiers lpx_get_obj_dir(LPX *lp) "
/**
 */
public";

%csmethodmodifiers lpx_get_num_rows(LPX *lp) "
/**
 */
public";

%csmethodmodifiers lpx_get_num_cols(LPX *lp) "
/**
 */
public";

%csmethodmodifiers lpx_get_row_name(LPX *lp, int i) "
/**
 */
public";

%csmethodmodifiers lpx_get_col_name(LPX *lp, int j) "
/**
 */
public";

%csmethodmodifiers lpx_get_row_type(LPX *lp, int i) "
/**
 */
public";

%csmethodmodifiers lpx_get_row_lb(LPX *lp, int i) "
/**
 */
public";

%csmethodmodifiers lpx_get_row_ub(LPX *lp, int i) "
/**
 */
public";

%csmethodmodifiers lpx_get_row_bnds(LPX *lp, int i, int *typx, double *lb, double *ub) "
/**
 */
public";

%csmethodmodifiers lpx_get_col_type(LPX *lp, int j) "
/**
 */
public";

%csmethodmodifiers lpx_get_col_lb(LPX *lp, int j) "
/**
 */
public";

%csmethodmodifiers lpx_get_col_ub(LPX *lp, int j) "
/**
 */
public";

%csmethodmodifiers lpx_get_col_bnds(LPX *lp, int j, int *typx, double *lb, double *ub) "
/**
 */
public";

%csmethodmodifiers lpx_get_obj_coef(LPX *lp, int j) "
/**
 */
public";

%csmethodmodifiers lpx_get_num_nz(LPX *lp) "
/**
 */
public";

%csmethodmodifiers lpx_get_mat_row(LPX *lp, int i, int ind[], double val[]) "
/**
 */
public";

%csmethodmodifiers lpx_get_mat_col(LPX *lp, int j, int ind[], double val[]) "
/**
 */
public";

%csmethodmodifiers lpx_create_index(LPX *lp) "
/**
 */
public";

%csmethodmodifiers lpx_find_row(LPX *lp, const char *name) "
/**
 */
public";

%csmethodmodifiers lpx_find_col(LPX *lp, const char *name) "
/**
 */
public";

%csmethodmodifiers lpx_delete_index(LPX *lp) "
/**
 */
public";

%csmethodmodifiers lpx_scale_prob(LPX *lp) "
/**
 */
public";

%csmethodmodifiers lpx_unscale_prob(LPX *lp) "
/**
 */
public";

%csmethodmodifiers lpx_set_row_stat(LPX *lp, int i, int stat) "
/**
 */
public";

%csmethodmodifiers lpx_set_col_stat(LPX *lp, int j, int stat) "
/**
 */
public";

%csmethodmodifiers lpx_std_basis(LPX *lp) "
/**
 */
public";

%csmethodmodifiers lpx_adv_basis(LPX *lp) "
/**
 */
public";

%csmethodmodifiers lpx_cpx_basis(LPX *lp) "
/**
 */
public";

%csmethodmodifiers lpx_simplex(LPX *lp) "
/**
 */
public";

%csmethodmodifiers lpx_exact(LPX *lp) "
/**
 */
public";

%csmethodmodifiers lpx_get_status(LPX *lp) "
/**
 */
public";

%csmethodmodifiers lpx_get_prim_stat(LPX *lp) "
/**
 */
public";

%csmethodmodifiers lpx_get_dual_stat(LPX *lp) "
/**
 */
public";

%csmethodmodifiers lpx_get_obj_val(LPX *lp) "
/**
 */
public";

%csmethodmodifiers lpx_get_row_stat(LPX *lp, int i) "
/**
 */
public";

%csmethodmodifiers lpx_get_row_prim(LPX *lp, int i) "
/**
 */
public";

%csmethodmodifiers lpx_get_row_dual(LPX *lp, int i) "
/**
 */
public";

%csmethodmodifiers lpx_get_row_info(LPX *lp, int i, int *tagx, double *vx, double *dx) "
/**
 */
public";

%csmethodmodifiers lpx_get_col_stat(LPX *lp, int j) "
/**
 */
public";

%csmethodmodifiers lpx_get_col_prim(LPX *lp, int j) "
/**
 */
public";

%csmethodmodifiers lpx_get_col_dual(glp_prob *lp, int j) "
/**
 */
public";

%csmethodmodifiers lpx_get_col_info(LPX *lp, int j, int *tagx, double *vx, double *dx) "
/**
 */
public";

%csmethodmodifiers lpx_get_ray_info(LPX *lp) "
/**
 */
public";

%csmethodmodifiers lpx_check_kkt(LPX *lp, int scaled, LPXKKT *kkt) "
/**
 */
public";

%csmethodmodifiers lpx_warm_up(LPX *lp) "
/**
 */
public";

%csmethodmodifiers lpx_eval_tab_row(LPX *lp, int k, int ind[], double val[]) "
/**
 */
public";

%csmethodmodifiers lpx_eval_tab_col(LPX *lp, int k, int ind[], double val[]) "
/**
 */
public";

%csmethodmodifiers lpx_transform_row(LPX *lp, int len, int ind[], double val[]) "
/**
 */
public";

%csmethodmodifiers lpx_transform_col(LPX *lp, int len, int ind[], double val[]) "
/**
 */
public";

%csmethodmodifiers lpx_prim_ratio_test(LPX *lp, int len, const int ind[], const double val[], int how, double tol) "
/**
 */
public";

%csmethodmodifiers lpx_dual_ratio_test(LPX *lp, int len, const int ind[], const double val[], int how, double tol) "
/**
 */
public";

%csmethodmodifiers lpx_interior(LPX *lp) "
/**
 */
public";

%csmethodmodifiers lpx_ipt_status(LPX *lp) "
/**
 */
public";

%csmethodmodifiers lpx_ipt_obj_val(LPX *lp) "
/**
 */
public";

%csmethodmodifiers lpx_ipt_row_prim(LPX *lp, int i) "
/**
 */
public";

%csmethodmodifiers lpx_ipt_row_dual(LPX *lp, int i) "
/**
 */
public";

%csmethodmodifiers lpx_ipt_col_prim(LPX *lp, int j) "
/**
 */
public";

%csmethodmodifiers lpx_ipt_col_dual(LPX *lp, int j) "
/**
 */
public";

%csmethodmodifiers lpx_set_class(LPX *lp, int klass) "
/**
 */
public";

%csmethodmodifiers lpx_get_class(LPX *lp) "
/**
 */
public";

%csmethodmodifiers lpx_set_col_kind(LPX *lp, int j, int kind) "
/**
 */
public";

%csmethodmodifiers lpx_get_col_kind(LPX *lp, int j) "
/**
 */
public";

%csmethodmodifiers lpx_get_num_int(LPX *lp) "
/**
 */
public";

%csmethodmodifiers lpx_get_num_bin(LPX *lp) "
/**
 */
public";

%csmethodmodifiers lpx_integer(LPX *lp) "
/**
 */
public";

%csmethodmodifiers lpx_intopt(LPX *lp) "
/**
 */
public";

%csmethodmodifiers lpx_mip_status(LPX *lp) "
/**
 */
public";

%csmethodmodifiers lpx_mip_obj_val(LPX *lp) "
/**
 */
public";

%csmethodmodifiers lpx_mip_row_val(LPX *lp, int i) "
/**
 */
public";

%csmethodmodifiers lpx_mip_col_val(LPX *lp, int j) "
/**
 */
public";

%csmethodmodifiers lpx_check_int(LPX *lp, LPXKKT *kkt) "
/**
 */
public";

%csmethodmodifiers lpx_reset_parms(LPX *lp) "
/**
 */
public";

%csmethodmodifiers lpx_set_int_parm(LPX *lp, int parm, int val) "
/**
 */
public";

%csmethodmodifiers lpx_get_int_parm(LPX *lp, int parm) "
/**
 */
public";

%csmethodmodifiers lpx_set_real_parm(LPX *lp, int parm, double val) "
/**
 */
public";

%csmethodmodifiers lpx_get_real_parm(LPX *lp, int parm) "
/**
 */
public";

%csmethodmodifiers lpx_read_mps(const char *fname) "
/**
 */
public";

%csmethodmodifiers lpx_write_mps(LPX *lp, const char *fname) "
/**
 */
public";

%csmethodmodifiers lpx_read_bas(LPX *lp, const char *fname) "
/**
 */
public";

%csmethodmodifiers lpx_write_bas(LPX *lp, const char *fname) "
/**
 */
public";

%csmethodmodifiers lpx_read_freemps(const char *fname) "
/**
 */
public";

%csmethodmodifiers lpx_write_freemps(LPX *lp, const char *fname) "
/**
 */
public";

%csmethodmodifiers lpx_read_cpxlp(const char *fname) "
/**
 */
public";

%csmethodmodifiers lpx_write_cpxlp(LPX *lp, const char *fname) "
/**
 */
public";

%csmethodmodifiers lpx_read_model(const char *model, const char *data, const char *output) "
/**
 */
public";

%csmethodmodifiers lpx_print_prob(LPX *lp, const char *fname) "
/**
 */
public";

%csmethodmodifiers lpx_print_sol(LPX *lp, const char *fname) "
/**
 */
public";

%csmethodmodifiers lpx_print_sens_bnds(LPX *lp, const char *fname) "
/**
 */
public";

%csmethodmodifiers lpx_print_ips(LPX *lp, const char *fname) "
/**
 */
public";

%csmethodmodifiers lpx_print_mip(LPX *lp, const char *fname) "
/**
 */
public";

%csmethodmodifiers lpx_is_b_avail(LPX *lp) "
/**
 */
public";

%csmethodmodifiers lpx_write_pb(LPX *lp, const char *fname, int normalized, int binarize) "
/**
 */
public";

%csmethodmodifiers lpx_main(int argc, const char *argv[]) "
/**
 */
public";
...
%csmethodmodifiers lpx_get_row_lb(glp_prob *lp, int i) "
/**
 */
public";

%csmethodmodifiers lpx_get_row_ub(glp_prob *lp, int i) "
/**
 */
public";

%csmethodmodifiers lpx_get_row_bnds(glp_prob *lp, int i, int *typx, double *lb, double *ub) "
/**
 */
public";
...
%csmethodmodifiers lpx_get_col_lb(glp_prob *lp, int j) "
/**
 */
public";

%csmethodmodifiers lpx_get_col_ub(glp_prob *lp, int j) "
/**
 */
public";

%csmethodmodifiers lpx_get_col_bnds(glp_prob *lp, int j, int *typx, double *lb, double *ub) "
/**
 */
public";
...
%csmethodmodifiers fill_smcp(LPX *lp, glp_smcp *parm) "
/**
 */
public";
...
%csmethodmodifiers lpx_get_status(glp_prob *lp) "
/**
 */
public";

%csmethodmodifiers lpx_get_prim_stat(glp_prob *lp) "
/**
 */
public";

%csmethodmodifiers lpx_get_dual_stat(glp_prob *lp) "
/**
 */
public";
...
%csmethodmodifiers lpx_get_row_info(glp_prob *lp, int i, int *tagx, double *vx, double *dx) "
/**
 */
public";
...
%csmethodmodifiers lpx_get_col_info(glp_prob *lp, int j, int *tagx, double *vx, double *dx) "
/**
 */
public";
...
%csmethodmodifiers lpx_ipt_status(glp_prob *lp) "
/**
 */
public";
...
%csmethodmodifiers solve_mip(LPX *lp, int presolve) "
/**
 */
public";
...
%csmethodmodifiers lpx_mip_status(glp_prob *lp) "
/**
 */
public";
...
%csmethodmodifiers reset_parms(LPX *lp) "
/**
 */
public";

%csmethodmodifiers access_parms(LPX *lp) "
/**
 */
public";
...
%csmethodmodifiers lpx_is_b_avail(glp_prob *lp) "
/**
 */
public";
...
%csmethodmodifiers lpx_put_mip_soln(glp_prob *lp, int i_stat, double row_mipx[], double col_mipx[]) "
/**
 */
public";
...
%csmethodmodifiers luf_create_it(void) "
/**
...
%csmethodmodifiers luf_defrag_sva(LUF *luf) "
/**
...
%csmethodmodifiers luf_enlarge_row(LUF *luf, int i, int cap) "
/**
...
%csmethodmodifiers luf_enlarge_col(LUF *luf, int j, int cap) "
/**
...
%csmethodmodifiers reallocate(LUF *luf, int n) "
/**
 */
public";

%csmethodmodifiers initialize(LUF *luf, int(*col)(void *info, int j, int rn[], double aj[]), void *info) "
/**
 */
public";

%csmethodmodifiers find_pivot(LUF *luf, int *_p, int *_q) "
/**
 */
public";

%csmethodmodifiers eliminate(LUF *luf, int p, int q) "
/**
 */
public";

%csmethodmodifiers build_v_cols(LUF *luf) "
/**
 */
public";

%csmethodmodifiers build_f_rows(LUF *luf) "
/**
 */
public";

%csmethodmodifiers luf_factorize(LUF *luf, int n, int(*col)(void *info, int j, int ind[], double val[]), void *info) "
/**
...
%csmethodmodifiers luf_f_solve(LUF *luf, int tr, double x[]) "
/**
...
%csmethodmodifiers luf_v_solve(LUF *luf, int tr, double x[]) "
/**
...
%csmethodmodifiers luf_a_solve(LUF *luf, int tr, double x[]) "
/**
...
%csmethodmodifiers luf_delete_it(LUF *luf) "
/**
...
%csmethodmodifiers mpl_get_row_bnds(MPL *mpl, int i, double *lb, double *ub) "
/**
 */
public";
...
%csmethodmodifiers mpl_get_col_bnds(MPL *mpl, int j, double *lb, double *ub) "
/**
 */
public";
...
%csmethodmodifiers wclique(int n, const int w[], const unsigned char a[], int ind[]) "
/**
 */
public";

%csmethodmodifiers kellerman(int n, int(*func)(void *info, int i, int ind[]), void *info, void *H) "
/**
 */
public";
...
%csmethodmodifiers wclique(int _n, const int w[], const unsigned char _a[], int ind[]) "
/**
 */
public";
...
%csmethodmodifiers npp_sat_split_pack(NPP *npp, NPPROW *row, int nnn) "
/**
 */
public";
...
%csmethodmodifiers genqmd(int *neqns, int xadj[], int adjncy[], int perm[], int invp[], int deg[], int marker[], int rchset[], int nbrhd[], int qsize[], int qlink[], int *nofsub) "
/**
 * genqmd - GENeral Quotient Minimum Degree algorithm .
 * <p>SYNOPSIS</p>
 * <p>#include \"glpqmd.h\" void genqmd(int *neqns, int xadj[], int adjncy[], int perm[], int invp[], int deg[], int marker[], int rchset[], int nbrhd[], int qsize[], int qlink[], int *nofsub);</p>
...
%csmethodmodifiers qmdrch(int *root, int xadj[], int adjncy[], int deg[], int marker[], int *rchsze, int rchset[], int *nhdsze, int nbrhd[]) "
/**
 * qmdrch - Quotient MD ReaCHable set .
 * <p>SYNOPSIS</p>
 * <p>#include \"glpqmd.h\" void qmdrch(int *root, int xadj[], int adjncy[], int deg[], int marker[], int *rchsze, int rchset[], int *nhdsze, int nbrhd[]);</p>
...
%csmethodmodifiers qmdqt(int *root, int xadj[], int adjncy[], int marker[], int *rchsze, int rchset[], int nbrhd[]) "
/**
 * qmdqt - Quotient MD Quotient graph Transformation .
 * <p>SYNOPSIS</p>
 * <p>#include \"glpqmd.h\" void qmdqt(int *root, int xadj[], int adjncy[], int marker[], int *rchsze, int rchset[], int nbrhd[]);</p>
...
%csmethodmodifiers qmdupd(int xadj[], int adjncy[], int *nlist, int list[], int deg[], int qsize[], int qlink[], int marker[], int rchset[], int nbrhd[]) "
/**
 * qmdupd - Quotient MD UPDate .
 * <p>SYNOPSIS</p>
 * <p>#include \"glpqmd.h\" void qmdupd(int xadj[], int adjncy[], int *nlist, int list[], int deg[], int qsize[], int qlink[], int marker[], int rchset[], int nbrhd[]);</p>
...
%csmethodmodifiers qmdmrg(int xadj[], int adjncy[], int deg[], int qsize[], int qlink[], int marker[], int *deg0, int *nhdsze, int nbrhd[], int rchset[], int ovrlp[]) "
/**
 * qmdmrg - Quotient MD MeRGe .
 * <p>SYNOPSIS</p>
 * <p>#include \"qmdmrg.h\" void qmdmrg(int xadj[], int adjncy[], int deg[], int qsize[], int qlink[], int marker[], int *deg0, int *nhdsze, int nbrhd[], int rchset[], int ovrlp[]);</p>
...
%csmethodmodifiers scf_create_it(int n_max) "
/**
...
%csmethodmodifiers f_loc(SCF *scf, int i, int j) "
/**
 */
public";

%csmethodmodifiers u_loc(SCF *scf, int i, int j) "
/**
 */
public";

%csmethodmodifiers bg_transform(SCF *scf, int k, double un[]) "
/**
 */
public";
...
%csmethodmodifiers gr_transform(SCF *scf, int k, double un[]) "
/**
 */
public";

%csmethodmodifiers transform(SCF *scf, int k, double un[]) "
/**
 */
public";

%csmethodmodifiers estimate_rank(SCF *scf) "
/**
 */
public";

%csmethodmodifiers scf_update_exp(SCF *scf, const double x[], const double y[], double z) "
/**
...
%csmethodmodifiers solve(SCF *scf, double x[]) "
/**
 */
public";

%csmethodmodifiers tsolve(SCF *scf, double x[]) "
/**
 */
public";

%csmethodmodifiers scf_solve_it(SCF *scf, int tr, double x[]) "
/**
...
%csmethodmodifiers scf_reset_it(SCF *scf) "
/**
 */
public";

%csmethodmodifiers scf_delete_it(SCF *scf) "
/**
...
%csmethodmodifiers spx_primal(glp_prob *lp, const glp_smcp *parm) "
/**
 */
public";

%csmethodmodifiers spx_dual(glp_prob *lp, const glp_smcp *parm) "
/**
 */
public";

%csmethodmodifiers alloc_csa(glp_prob *lp) "
/**
 */
public";

%csmethodmodifiers alloc_N(struct csa *csa) "
/**
 */
public";

%csmethodmodifiers build_N(struct csa *csa) "
/**
 */
public";

%csmethodmodifiers init_csa(struct csa *csa, glp_prob *lp) "
/**
 */
public";

%csmethodmodifiers inv_col(void *info, int i, int ind[], double val[]) "
/**
 */
public";

%csmethodmodifiers invert_B(struct csa *csa) "
/**
 */
public";

%csmethodmodifiers update_B(struct csa *csa, int i, int k) "
/**
 */
public";

%csmethodmodifiers error_ftran(struct csa *csa, double h[], double x[], double r[]) "
/**
 */
public";

%csmethodmodifiers refine_ftran(struct csa *csa, double h[], double x[]) "
/**
 */
public";

%csmethodmodifiers error_btran(struct csa *csa, double h[], double x[], double r[]) "
/**
 */
public";

%csmethodmodifiers refine_btran(struct csa *csa, double h[], double x[]) "
/**
 */
public";

%csmethodmodifiers add_N_col(struct csa *csa, int j, int k) "
/**
 */
public";

%csmethodmodifiers del_N_col(struct csa *csa, int j, int k) "
/**
 */
public";

%csmethodmodifiers get_xN(struct csa *csa, int j) "
/**
 */
public";

%csmethodmodifiers eval_beta(struct csa *csa, double beta[]) "
/**
 */
public";

%csmethodmodifiers eval_pi(struct csa *csa, double pi[]) "
/**
 */
public";

%csmethodmodifiers eval_cost(struct csa *csa, double pi[], int j) "
/**
 */
public";

%csmethodmodifiers eval_bbar(struct csa *csa) "
/**
 */
public";

%csmethodmodifiers eval_cbar(struct csa *csa) "
/**
 */
public";

%csmethodmodifiers reset_refsp(struct csa *csa) "
/**
 */
public";

%csmethodmodifiers eval_gamma(struct csa *csa, int j) "
/**
 */
public";

%csmethodmodifiers chuzc(struct csa *csa, double tol_dj) "
/**
 */
public";

%csmethodmodifiers eval_tcol(struct csa *csa) "
/**
 */
public";

%csmethodmodifiers refine_tcol(struct csa *csa) "
/**
 */
public";

%csmethodmodifiers sort_tcol(struct csa *csa, double tol_piv) "
/**
 */
public";

%csmethodmodifiers chuzr(struct csa *csa, double rtol) "
/**
 */
public";

%csmethodmodifiers eval_rho(struct csa *csa, double rho[]) "
/**
 */
public";

%csmethodmodifiers refine_rho(struct csa *csa, double rho[]) "
/**
 */
public";

%csmethodmodifiers eval_trow(struct csa *csa, double rho[]) "
/**
 */
public";

%csmethodmodifiers update_bbar(struct csa *csa) "
/**
 */
public";

%csmethodmodifiers reeval_cost(struct csa *csa) "
/**
 */
public";

%csmethodmodifiers update_cbar(struct csa *csa) "
/**
 */
public";

%csmethodmodifiers update_gamma(struct csa *csa) "
/**
 */
public";

%csmethodmodifiers err_in_bbar(struct csa *csa) "
/**
 */
public";

%csmethodmodifiers err_in_cbar(struct csa *csa) "
/**
 */
public";

%csmethodmodifiers err_in_gamma(struct csa *csa) "
/**
 */
public";

%csmethodmodifiers change_basis(struct csa *csa) "
/**
 */
public";

%csmethodmodifiers set_aux_obj(struct csa *csa, double tol_bnd) "
/**
 */
public";

%csmethodmodifiers set_orig_obj(struct csa *csa) "
/**
 */
public";

%csmethodmodifiers check_stab(struct csa *csa, double tol_bnd) "
/**
 */
public";

%csmethodmodifiers check_feas(struct csa *csa, double tol_bnd) "
/**
 */
public";

%csmethodmodifiers eval_obj(struct csa *csa) "
/**
 */
public";

%csmethodmodifiers display(struct csa *csa, const glp_smcp *parm, int spec) "
/**
 */
public";

%csmethodmodifiers store_sol(struct csa *csa, glp_prob *lp, int p_stat, int d_stat, int ray) "
/**
 */
public";

%csmethodmodifiers free_csa(struct csa *csa) "
/**
 */
public";
...
%csmethodmodifiers eval_gamma(struct csa *csa, double gamma[]) "
/**
 */
public";

%csmethodmodifiers chuzr(struct csa *csa, double tol_bnd) "
/**
 */
public";
...
%csmethodmodifiers eval_trow1(struct csa *csa, double rho[]) "
/**
 */
public";

%csmethodmodifiers eval_trow2(struct csa *csa, double rho[]) "
/**
 */
public";
...
%csmethodmodifiers sort_trow(struct csa *csa, double tol_piv) "
/**
 */
public";

%csmethodmodifiers chuzc(struct csa *csa, double rtol) "
/**
 */
public";
...
%csmethodmodifiers check_feas(struct csa *csa, double tol_dj) "
/**
 */
public";

%csmethodmodifiers set_aux_bnds(struct csa *csa) "
/**
 */
public";

%csmethodmodifiers set_orig_bnds(struct csa *csa) "
/**
 */
public";

%csmethodmodifiers check_stab(struct csa *csa, double tol_dj) "
/**
 */
public";
...
%csmethodmodifiers get_char(struct dsa *dsa) "
/**
 */
public";

%csmethodmodifiers skip_spaces(struct dsa *dsa, int across) "
/**
 */
public";

%csmethodmodifiers scan_keyword(struct dsa *dsa) "
/**
 */
public";

%csmethodmodifiers check_colon(struct dsa *dsa) "
/**
 */
public";

%csmethodmodifiers scan_token(struct dsa *dsa, int across) "
/**
 */
public";

%csmethodmodifiers check_newline(struct dsa *dsa) "
/**
 */
public";

%csmethodmodifiers scan_comment(struct dsa *dsa) "
/**
 */
public";

%csmethodmodifiers scan_integer(struct dsa *dsa, int across, int *val) "
/**
 */
public";

%csmethodmodifiers scan_number(struct dsa *dsa, int across, double *val) "
/**
 */
public";

%csmethodmodifiers tsp_read_data(char *fname) "
/**
 */
public";

%csmethodmodifiers tsp_free_data(TSP *tsp) "
/**
 */
public";

%csmethodmodifiers rad(double x) "
/**
 */
public";

%csmethodmodifiers tsp_distance(TSP *tsp, int i, int j) "
/**
 */
public";
